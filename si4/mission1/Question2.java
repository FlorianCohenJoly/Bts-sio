...
public class Question2 {
		public static void main (String [] args) {
			double prixTTC; // prixTTC est un un réél double précision
			double prixHT;  // prixHT est un réél double précision
			prixHT=7;       // j'affecte la valeur 7 au prixHT
			double tauxTVA; // tauxTVA est un réél double précision
			tauxTVA=5;      // j'affecte la valeur 5 au tauxTVA
			double quantite; // quantite est un réél double precision
